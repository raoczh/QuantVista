...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/', name: 'home', component: Home, meta: { title: '今日概览' } },
  { path: '/mood', name: 'mood', component: () => import('@/pages/Mood.vue'), meta: { title: '盘面情绪' } },
  ...
  { path: '/heatmap', name: 'heatmap', component: () => import('@/pages/Heatmap.vue'), meta: { title: '行业热力图' } },
  { path: '/boards/:code', name: 'board-detail', component: () => import('@/pages/BoardDetail.vue'), meta: { title: '板块详情' } },
  ...
  { path: '/portfolio-risk', name: 'portfolio-risk', component: () => import('@/pages/PortfolioRisk.vue'), meta: { title: '组合风险' } },
  ...
  { path: '/admin/joint-eval', name: 'admin-joint-eval', component: () => import('@/pages/AdminJointEval.vue'), meta: { title: '组合/回测联合评估', admin: true } },
