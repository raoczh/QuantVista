...
export type RankingAlgorithm = 'qr1' | 'qr2' | 'qr3' | 'additive_sp1' | 'ridge1'
export const CURRENT_RANKING_ALGORITHM: RankingAlgorithm = 'qr3'
export const RANKING_ALGORITHM_LABEL: Record<RankingAlgorithm, string> = {
  qr1: '历史质量规则（新任务使用当前规则）', qr2: '历史质量规则（新任务使用当前规则）', qr3: '质量规则', additive_sp1: '原加法评分对照', ridge1: '学习排序',
}
