...
export interface UserPreference {
  ...
  investment_guide_version: number // 三问投资偏好向导版本；0=从未完成/跳过
  investment_guide_status: 'not_started' | 'completed' | 'skipped'
  guard_config_json: string // 智能守护配置（guardConfig JSON；空=默认全开）
}
