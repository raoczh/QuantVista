...
| 选股与回测 | 30 个内置选股策略、4 个参数模板、自定义条件树、自然语言生成策略、因子扫描、历史时点回测与执行约束模拟 |
...
内置策略包含均线金叉、放量突破后回踩、布林收口突破、55 日通道突破、KDJ 低位修复，以及 DMI 趋势确认、NR7 窄幅突破、长期趋势内 RSI2 修复和 50/150/200 日趋势模板。选股条件、推荐侧重与入场确认相互对应；财务质量核对已披露年报 ROE、当期归母/扣非盈利和上年同期金额，区分亏损收窄、扭亏与正盈利基期增长，缺失数据不会冒充真实零值。
