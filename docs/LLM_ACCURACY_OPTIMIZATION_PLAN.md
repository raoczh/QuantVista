...
> 状态：方案基线（v1.6；P0 第二批已实施——P0-2 统一运行元数据 + P0-8 调用关联/审计完整性元数据；此前 P0-1 全部 + P0-7 stale/PIT 与机读拒答码已实施）<br>
> 编制日期：2026-07-19；v1.4 修订：2026-07-20；v1.5 修订：2026-07-21（Asia/Shanghai）；v1.5 审查修复：2026-07-21（repair 漏标、完整性门禁、日报/新闻 PIT、拒答码端到端、取消审计脱敏）；v1.6：2026-07-21（P0-2/P0-8 实施）<br>
