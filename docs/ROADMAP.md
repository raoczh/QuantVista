...
> 进度：市场首页已从验证页升级为**市场看板**（指数概览/涨幅榜/热门榜/板块榜/个股速查 + 情绪/资金流/新闻/AI 占位，commit `00d927a`）。指数/榜单/个股走新浪（稳），板块走东财 clist（间歇限流，best-effort）。**未做**：日线/交易日历批量入库、市场快照表、涨跌家数等市场情绪、资金流。
