...
const (
	...
	sentiPromptVersion  = "n2" // n2: 每条输入恰好一项、禁额外字段与解释的输出瘦身；n1: 初版
)
...
只输出紧凑 JSON：{"items":[{"id":新闻id,"sentiment":"positive|negative|neutral","sentiment_score":-1~1的小数,"impact_scope":"market|sector|stock","related_sectors":["..."],"policy_level":0|3|4|5}]}，不要任何解释、空行或代码块标记。`
