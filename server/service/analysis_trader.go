...
func (s *AnalysisService) attachTradePlan(ctx context.Context, cfg *model.LLMConfig, apiKey string, allowPrivate bool, req AnalyzeRequest, snapshot map[string]any, result *AnalysisResult) chatUsage {
	...
	_, usage, _, callErr := s.callWithRepair(ctx, cfg, apiKey, allowPrivate, messages, parse, tradePlanRepairHint)
