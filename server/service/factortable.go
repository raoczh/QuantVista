...
var factorDefs = []factorDef{
	...
	{"rsi_2", "RSI(2)", "指标", fkRatio, "2日 Wilder RSI，至少30根完整日线预热；短期过冷/过热不等于趋势反转"},
	{"rsi2_previous", "上一日RSI(2)", "指标", fkRatio, "上一完整日 RSI2，用于验证先超卖后修复"},
	{"rsi2_reclaim", "RSI2超卖收复", "形态", fkBool, "昨日RSI2<10，今日回到10及以上，且收盘上涨、低点不再下移；至少30根"},
	{"ma50", "MA50", "均线", fkPrice, "完整50日收盘均价"},
	{"ma150", "MA150", "均线", fkPrice, "完整150日收盘均价"},
	{"ma200", "MA200", "均线", fkPrice, "完整200日收盘均价"},
	{"ma200_rising", "MA200上行", "均线", fkBool, "当前MA200高于20个交易日前的MA200；至少220根完整日线"},
	{"dmi_pdi14", "DMI +DI(14)", "指标", fkRatio, "Wilder完整窗口种子的正向指标，至少150根预热"},
	{"dmi_mdi14", "DMI -DI(14)", "指标", fkRatio, "Wilder完整窗口种子的负向指标，至少150根预热"},
	{"adx_14", "ADX(14)", "指标", fkRatio, "Wilder双重平滑趋势强度，至少150根预热；高ADX也可能是下跌趋势"},
	{"adx_rising", "ADX回升", "指标", fkBool, "最新完整日ADX14高于上一日，只描述趋势强度变化"},
	{"dmi_bull_cross", "DMI多头交叉", "形态", fkBool, "近3日+DI上穿-DI，且当前仍在其上；至少150根"},
	{"nr7_break", "NR7窄幅突破", "形态", fkBool, "昨日高低振幅严格小于此前6日，今日收盘突破昨日高点；7日均有成交且昨日不是一字线，至少8根"},
	{"nr7_level", "NR7突破参照价", "形态", fkPrice, "满足NR7窄幅条件的上一完整日最高价；有价不代表已突破"},
	{"long_trend_template", "长期趋势模板", "形态", fkBool, "收盘>MA50>MA150>MA200，MA200高于20日前；收盘距250日低点≥30%，距250日高点≤25%；至少250根，不含相对强度排名"},
