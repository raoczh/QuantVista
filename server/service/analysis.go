...
const (
	analysisPromptVersion   = "p4" // p4: 个股快照注入五维量化评分锚点；全模块要求结论引用具体数值、禁用先验记忆；p3: 反方观点/失效条件/数据盲区
...
3. 关键判断必须引用【数据】中的具体字段与数值佐证（如「现价 12.34 站上 MA20=11.98」「主力净流入 23.5 亿」），让用户可以逐条核对。
